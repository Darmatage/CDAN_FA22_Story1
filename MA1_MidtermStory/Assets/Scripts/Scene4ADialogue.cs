...
// ENCOUNTER AFTER CHOICE #2
                ...
                Char1name.text = "Ohzi";
                Char1speech.text = "But Moosh you don't understand NOBODY will accept us as we are once they realize-";
                Char2name.text = "";
                Char2speech.text = "";
        }
...
// FUNCTIONS FOR BUTTONS TO ACCESS (Choice #1 and switch scenes)
        ...
        public void Choice1bFunct(){
                Char1name.text = "Ohzi";
                Char1speech.text = "But nobody understands! Nobody will accept us as we are!";
                Char2name.text = "";
                Char2speech.text = "";
                primeInt = 199;
                Choice1a.SetActive(false);
