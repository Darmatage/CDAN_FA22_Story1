...
public void talking(){         // main story function. Players hit next to progress to next int
        ...
        if (primeInt == 1){
		   ...
		   ArtChar2.SetActive(true);
                Char1name.text = "Ohzi";
                Char1speech.text = "Exactly my point. This little guy is not only a pigeon but a ‘Super Smart Genius Pigeon’™!!!";
                Char2name.text = "";
                Char2speech.text = "";
				Char3name.text = "";
                Char3speech.text = "";
		   ...
		   ArtChar1b.SetActive(false);
			...
			ArtChar3c.SetActive(false);
                ...
                Char3speech.text = "";
                 ...
                 Char1name.text = "";
                 Char1speech.text = "Honestly it's nice to get a break from everyone. I feel like we're the only sane ones sometimes.";
                 Char2name.text = "";
                 Char2speech.text = "";
				 Char3name.text = "";
                Char3speech.text = "";
			...
			ArtChar2b.SetActive(true);
                ...
                Char3speech.text = "";
                 ...
                 Char1name.text = "Ohzi";
                 Char1speech.text = "I know the Irony… To anyone else I’m just talking to a pigeon…basically talking to myself.";
                 Char2name.text = "";
                 Char2speech.text = "";
				 Char3name.text = "";
                Char3speech.text = "";
			...
			ArtChar3.SetActive(false);
                       ...
                       Char2speech.text = "";
                       Char3name.text = "Mad Scientist";
                       Char3speech.text = "We think it fits the vibe don’t you? Sleek a little spooooky even??";
               }
              else if (primeInt == 39){
                      Char1name.text = "";
                      Char1speech.text = "";
				...
				ArtChar2.SetActive(false);
                         ...
                         Char1speech.text = "";
                         Char2name.text = "Pigeon";
                         Char2speech.text = "CooOo Coo Coo?";
                         Char3name.text = "";
                         Char3speech.text = "";
				}
                else if (primeInt == 45){
                         ...
                         Char2speech.text = "";
                         Char3name.text = "Mad Scientist";
                         Char3speech.text = " Yes, yes, we’ll get to that another time don’tttt worryyyy.";
				}
                else if (primeInt == 46){
                         Char1name.text = "Ohzi";
                         Char1speech.text = " …Uh.";
